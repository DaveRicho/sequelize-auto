         ...
         //   }
          ...
          if (attr === "type") {
            ...
            if (field_type2.match(/^date/) || field_type2.match(/^smalldatetime/)) {
              ...
              text[table] += "\n";
              text[table] += spaces + spaces + spaces + spaces + "if (!Moment.utc(this.getDataValue('client_first_earliest_start_date')).isValid()) {";
              text[table] += "\n";
              text[table] += spaces + spaces + spaces + spaces + spaces + spaces + "return null;";
              text[table] += "\n";
              text[table] += spaces + spaces + spaces + spaces + "}";
              text[table] += "\n";
              text[table] += spaces + spaces + spaces + spaces + `return Moment.utc(this.getDataValue('${fieldName}')).format('YYYY-MM-DD HH:MM:SS');`;
              text[table] += "\n";
              text[table] += spaces + spaces + spaces + "}";
              text[table] += ",\n";
            }
